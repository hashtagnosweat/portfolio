    ...
    >
      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-between h-full px-4 md:flex-row">
        ...
        <div className="flex flex-col justify-center h-full md:mr-10">
          ...
          <div>
            <button className="group text-white w-fit px-6 py-2 my-2 lg:flex items-center rounded-md bg-gradient-to-l from-cyan-500 to-blue-500 cursor-pointer">
            <Link to="about" smooth duration={500}>Get to know me!</Link>
              <span className="hidden sm:flex group-hover:rotate-90 duration-300">
